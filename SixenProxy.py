...
def usage():
	print '-------------------------------------------------------'
	print '-    SixenProxy.py                                    -'          
	print '-    Data de criacao: 17/04/2016 - Versao 1.0.0       -'
        print '-   _____ _                _____                      -'
        print '-  / ____(_)              |  __ \                     -'
        print '- | (___  ___  _____ _ __ | |__) | __ _____  ___   _  -'
        print '-  \___ \| \ \/ / _ \  _ \|  ___/  __/ _ \ \/ / | | | -'
        print '-  ____) | |>  <  __/ | | | |   | | | (_) >  <| |_| | -'
        print '- |_____/|_/_/\_\___|_| |_|_|   |_|  \___/_/\_\\__, | -'
        print '-                                               __/ | -'
        print '-                                      Oficial |___/  -'
        print '-  By C0m4nd0 s0mbr4                                  -'
        print '-                                                     -'    
	print '-------------------------------------------------------'
	print ''
	print ''
	...
	print '- Ataque:'
	print ''
	print '- python SixenProxy.py <url>'
	print ''
	print '- Ex: python SixenProxy.py http://site.com'
	print ''
	print '- Para ataque seguro: python SixAttack.py <url> safe' 
	print ''
	print '- Ex: python SixenProxy.py http://site.com safe'
	print "\a"
print \
...
if len(sys.argv) < 2:
    ...
    if sys.argv[1]=="help":
        ...
        print "#~>   ATAQUE INICIADO COM SUCESSO!  <~#"
        url = sys.argv[1]
        if url.count("/")==2:
            url = url + "/"
